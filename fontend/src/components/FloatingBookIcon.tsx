...
const FloatingBookIcon: React.FC<{ count?: number; onClick?: () => void }> = ({ count, onClick }) => {
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#16a34a] text-white flex items-center justify-center shadow-xl hover:shadow-2xl transition-transform transform hover:scale-105"
    >
