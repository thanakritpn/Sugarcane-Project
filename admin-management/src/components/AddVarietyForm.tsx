...
const AddVarietyForm = ({
  ...
  return (
    <div className="max-h-[80vh] overflow-auto px-6 pb-6 space-y-4">
      ...
      <label className="relative h-32 border-2 border-dashed rounded-lg flex items-center justify-center overflow-hidden text-gray-500 bg-gray-50 hover:bg-gray-100 transition cursor-pointer">
